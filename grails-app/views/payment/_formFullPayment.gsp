...
<div class="fieldcontain ${hasErrors(bean: paymentInstance, field: 'lodger', 'error')} required">
	...
	<td>
	<g:hiddenField name="lodger.id" value="${lodgerInstance.id}"/>${lodgerInstance.firstName} ${lodgerInstance.middleName} ${lodgerInstance.lastName}</td>
</div>
</tr>
...
<div class="fieldcontain ${hasErrors(bean: paymentInstance, field: 'balance', 'error')} required">
	...
	<td>
	<g:hiddenField name="balance" value="${lodgerInstance.previousBalance}"/>${lodgerInstance.previousBalance}</td>
</div>
</tr>
...
<div class="fieldcontain ${hasErrors(bean: paymentInstance, field: 'paymentStatus', 'error')} ">
	...
	<td>
	<g:hiddenField name="paymentStatus" value="${paymentStatus}"/>${paymentStatus}</td>
</div>
...
<div class="fieldcontain ${hasErrors(bean: paymentInstance, field: 'amountPaid', 'error')} required">
	...
	<td><g:hiddenField name="amountPaid" value="${totalBill}" />${totalBill}</td>
</div>
</tr>
