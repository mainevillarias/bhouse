...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<div id="menu">
		<ul>
			...
			<li><g:link action="viewAvailableRooms" controller="Room">Reserve a room!</g:link></li>
		</ul>
	</div>
</div>
...
<div id="page-wrapper">
	<div id="page">
		...
		<div align="right">	
					...
					<g:form action="search" controller="search" class="">
					<g:textField class="textfield" name="parameter" value="${params.input}" size="20" placeholder="Type some text here"/>
					<g:select name="resultType" from="['lodger','reservation code', 'or number', 'room name']" required="" value=""/>
